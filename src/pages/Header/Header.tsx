    ...
    <section className="hero">
      ...
      <div className="container">
        <div className="content">
          ...
          <h1 className="name">Bhadmus Oluwaseyi</h1>
          <h2 className="title">Frontend Developer & Creative Technologist</h2>
          <p className="description">
            I'm a passionate frontend developer with a <span className="highlight">creative edge</span>, dedicated to crafting immersive digital experiences. With a keen eye for design and a strong command of cutting-edge web technologies, I specialize in turning concepts into captivating user interfaces.
          </p>
