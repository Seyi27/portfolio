...
function Work() {
  ...
  const works = [
    ...
    },
    {
      ...
      description:
        "A web app that enables seamless online shopping, supports multiple payment options, provides personalized recommendations, and ensures a user-friendly experience for customers and vendors.",
      tag: "Web App",
    ...
    },
    {
      ...
      description:
        "A web app designed for vendors to easily manage their online stores, upload and organize products, track sales and transactions, and receive real-time insights, all while providing a seamless connection to customers through the Saleko marketplace.",
      tag: "Web App",
      stack: ["React", "Typescript", "Redux"],
    ...
    },
    {
      title: "Portfolio",
      description:
        "A personal portfolio web app showcasing the works and skills of the client.",
      tag: "Web App",
    ...
    },
    {
      ...
      description:
        "Developed a modern, responsive website for a wealth management company, showcasing their tailored investment solutions and services. Focused on delivering a professional user experience that reflects trust, growth, and financial confidence.",
      tag: "Web App",
    ...
    },
    {
      ...
      description:
        "The EcoMap Platform is a web application that connects Startups (Founders) with Enablers (investors, government agencies, startup ecosystem builders) under the supervision and support of a Platform Team (Super User, Admins, and Support Teams).",
      tag: "Web App",
    ...
    },
    {
      title: "Connectly",
      description:
        "Connectly is a real-time voice communication platform that enables businesses to manage customer calls affordably and efficiently.",
      tag: "Web App",
    ...
    },
    {
      ...
      description:
        "A web app that features a multilingual, secure banking chatbot with an adaptive UI, dynamic translations, conversational workflows for key operations, live agent escalation, and seamless integration with core banking systems.",
      tag: "Web App",
    ...
    },
    {
      ...
      description:
        "A mobile app for digital onboarding, multilingual support across 33 countries, and SME-focused features like account management, payments, and loans, with real-time data synchronization via API integration.",
      tag: "Mobile App",
    ...
    },
    {
      ...
      description:
        "A mobile app that streamlines onboarding, fosters growth, supports continuous feedback, and aligns with company goals to enhance employee integration and satisfaction.",
      tag: "Mobile App",
      stack: ["React Native"],
      projectLink: "",
      codeLink: "",
  ...
  return (
    <>
      <div className="app__works">
        ...
        <p className="app__flex work_subtitle">
        ...
        >
          {filterWorks.map((work: any, index) => (
              ...
              <a href={work.projectLink} style={{ textDecorationLine: "none" }}>
                ...
                <div className="app__work-content app__flex">
                  ...
                  <div className="app__stack">
                    {work.stack.map((stack: any, index: any) => (
                      <div key={index}>
